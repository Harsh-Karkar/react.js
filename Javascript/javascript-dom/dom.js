...

{
    ...
    // document.getElementsByClassName('box').innerHTML = "hello harsh"//
...
//                 element[i].style.border = "20px solid  magenta"
...

{
    ...
    // document.querySelectorAll('.box').style.color = "yellow";
}
...

{
    ...
    // newelement.classList.add("hari1");
    newelement.classList = "hari2 harsh";
    document.body.appendChild(newelement);
}